//! IND-sID-CPA secure IBKEM from the Boyen & Waters IBE scheme
...
pub const PK_BYTES: usize = 6 * G1_SIZE + 2 * G2_SIZE + GT_SIZE;
pub const SK_BYTES: usize = 5 * SCALAR_SIZE;
pub const USK_BYTES: usize = 5 * G2_SIZE;
pub const CT_BYTES: usize = 5 * G1_SIZE;
